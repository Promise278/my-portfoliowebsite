  ...
  return (
    <div className='bg-gradient-to-r from-gray-200 to-gray-800'>
      <nav className='fixed inset-x-0 top-0 left-0 z-30 flex justify-between pt-6 pl-12 pr-12 h-20 backdrop-blur-sm'>
        <div>
          <h3 className='md:text-3xl text-white text-1xl'>Promise Obi</h3>
        </div>
      ...
      <div id='home' data-aos="fade-up" className='pt-36 flex justify-around md:flex-row flex-col'>
        ...
        <div class="flex items-center justify-center p-4">
          <img class="w-72 h-72 rounded-full border-4 border-gray-500 shadow-lg" src="../img/bl-_11_.png" alt="Profile Picture" />
        </div>
      </div>
      ...
      <div id='about' className='mt-24 md:flex-row flex-col'>
        ...
        <div data-aos="zoom-in-right" className='flex gap-8 rounded-md md:w-[80%] w-[90%] md:h-76 md:ml-32 ml-4 mt-8 bg-black md:flex-row flex-col'>
          <div>
      ...
      <div id='services' data-aos="zoom-in-down" className='flex justify-between gap-8 border-2 rounded-md md:w-[80%] w-[90%] md:h-76 md:ml-32 ml-4 mt-12 bg-black text-white md:flex-row flex-col'>
        ...
        <div data-aos="zoom-in-left" className='flex gap-6 pt-8 pb-8 mr-12 md:flex-row flex-col'>
          <div className='flex gap-6'>
            ...
            <div className='bg-blue-500 rounded-md w-32 h-32 md:ml-0 ml-12'>
          ...
          <div className='flex gap-6'>
            ...
            <div className='bg-blue-400 rounded-md w-32 h-32 md:ml-0 ml-12'>
      ...
      <div id='contact' data-aos="zoom-out-up" className='md:w-[80%] w-[90%] md:h-76 bg-black mt-32 flex gap-6 rounded-md md:ml-32 ml-6 md:flex-row flex-col'>
        ...
        <div className='md:mt-12 mt-4 md:pl-0 pl-6'>
          <input className='bg-black border-2 border-gray-800 rounded-md md:w-96 w-80 text-white h-10 pl-2' required type="text" placeholder='Name' /> <br />
          <input className='bg-black border-2 border-gray-800 rounded-md md:w-96 w-80 text-white h-10 pl-2 mt-4' required type="email" placeholder='Email' /> <br />
          <input className='bg-black border-2 border-gray-800 rounded-md md:w-96 w-80 text-white h-10 pl-2 mt-4' required type="Subject" placeholder='Subject' /> <br />
          <textarea className='bg-black border-2 border-gray-800 rounded-md md:w-96 w-80 text-white h-32 mt-4' required name="" placeholder="Write your message"></textarea>
          <button className='bg-white text-black hover:bg-gray-800 text-2xl hover:text-white h-12 pt-1 md:w-96 w-80 rounded-md md:mt-6 mt-4 md:mb-0 mb-4'>Submit</button>
        </div>
      </div>
    </div>
  )
