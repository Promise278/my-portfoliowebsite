    ...
    <div className='bg-gradient-to-r from-gray-200 to-gray-800 overflow-hidden'>
      ...
      <div id='home' data-aos="fade-up" className='pt-36 flex justify-around md:flex-row flex-col'>
        ...
        <div class="flex items-center justify-center p-4">
          <img class="w-72 h-72 rounded-full border-4 border-gray-500 shadow-lg object-cover" src="/profile.png" alt="Profile Picture" />
        </div>
      </div>
      ...
      <div id='about' className='mt-24 md:flex-row flex-col'>
        ...
        <div data-aos="zoom-out-down" className='flex gap-6 rounded-md md:w-[80%] w-[90%] md:h-76 md:ml-32 ml-4 mt-8 bg-black md:flex-row flex-col'>
          <div>
            <img data-aos="zoom-in-right" className='md:w-60 w-72 rounded-md md:h-72 h-72 md:ml-6 ml-2  mt-6 mb-6' src="/img/IMG_7263.JPG" alt="Profile image" />
          </div>
          <div>
